...
const bj = [
    ...
    { title: '颐和园', english: 'palace museum', picpath: require('../../assets/lzy/dyiheyuan.png') },
                ...
                <ImageBackground source={require("../../assets/dqh/search.jpg")} style={{width: '100%',}}>
                    <View style={styles.head}>
                        <View style={styles.search}>
                            ...
                            <Icon name="search" style={{fontSize:30 * s,marginLeft:240 * s,color:"green"}} onPress={()=>Actions.showresult()}/>
                        </View>
                    </View>
                </ImageBackground>
                <ScrollView>
